...
data = pd.read_csv('./data/selected/timeseries1.csv', delimiter=',', index_col=False, header=0)
nodes = string_nodes(data.columns)
tsfci_result_df = pd.read_csv('./tsfci_results/result_1.csv', header=0, index_col=0)
